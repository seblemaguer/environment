...
then
    ...
    # Install viu
    wget https://github.com/atanunq/viu/releases/download/v1.6.1/viu-x86_64-unknown-linux-musl
    mv viu-x86_64-unknown-linux-musl $PREFIX/bin/viu
    chmod +x $PREFIX/bin/viu
fi
